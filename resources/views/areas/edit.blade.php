                    ...
                    <div class="row justify-content-between">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="media mb-2 gap-3 align-items-center">
                                    ...
                                    <div class="media-body ">
                                        <p class="m-0">Use this to drag map to find proper area</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="floatingInput" name="name" placeholder="Area name" required value="{{ $area->name }}">
                                @error('name')
...
@endsection
@push('scripts')
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('app.google_api_key') }}&libraries=drawing,places">
    </script>
